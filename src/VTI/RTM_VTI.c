/*
 * Elastic Reverse Time Migration RTM (2D PSV VTI problem)  
 *
 * Daniel Koehn
 * Kiel, 15/02/2017
 */
...
L2sum = grad_obj_VTI(&wavePSV, &wavePSV_PML, &matVTI, &fwiPSV, &mpiPSV, &seisPSV, &seisPSVfwi, &acq, hc, iter, nsrc, ns, ntr, ntr_glob, 
