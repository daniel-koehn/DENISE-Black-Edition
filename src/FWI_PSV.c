...
float sum, eps_scale, opteps_vp, opteps_vs, opteps_rho, Vp_avg, C_vp, Vs_avg, C_vs, rho_avg, C_rho, Vs_sum, Vp_sum, rho_sum;
...
if(GRAD_METHOD==1){
  PCG(fwiPSV.waveconv, taper_coeff, nsrc, acq.srcpos, acq.recpos, ntr_glob, iter, C_vp, fwiPSV.gradp, fwiPSV.waveconv_u, C_vs, fwiPSV.gradp_u, fwiPSV.waveconv_rho, C_rho, fwiPSV.gradp_rho);
}

if(GRAD_METHOD==2){
  LBFGS1(taper_coeff, nsrc, acq.srcpos, acq.recpos, ntr_glob, iter, fwiPSV.waveconv, C_vp, fwiPSV.gradp, fwiPSV.waveconv_u, C_vs, fwiPSV.gradp_u, fwiPSV.waveconv_rho, C_rho, fwiPSV.gradp_rho, y_LBFGS, s_LBFGS, rho_LBFGS, alpha_LBFGS, matPSV.ppi, matPSV.pu, matPSV.prho, NXNYI, q_LBFGS, r_LBFGS, beta_LBFGS, LBFGS_pointer, NLBFGS, NLBFGS_vec);
}
